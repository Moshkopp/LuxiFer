...
use luxifer_core::{
    ...
    rename_project, rendered_png, AppState, Geo, ImageParams, LaserRegistry, PolyShape,
    ProjectFile, ProjectInfo, ShapeInfo, UiSettings, VersionInfo,
};
use serde::Serialize;
...
use commands::laser::*;
use shared::{
    base64_encode, plan_with_assets, read_png_data_url, remember_last_project, scene, scene_with,
