...
pub(in crate::ui) fn material_manager_window(
    ...
    .show(root_ui, |ui| {
        ...
        for process in luxifer_core::MaterialProcess::ALL {
...
fn process_editor(
    ui: &mut egui::Ui,
    profile: &mut luxifer_core::MaterialProfile,
    process: luxifer_core::MaterialProcess,
) {
        ...
        .show(ui, |ui| {
            ...
            egui::Grid::new(("material_process", process))
                ...
                .show(ui, |ui| {
                    ...
                    ui.end_row();
                    match process {
                        luxifer_core::MaterialProcess::Cut => {}
                        luxifer_core::MaterialProcess::VectorEngrave => {
                        ...
                        luxifer_core::MaterialProcess::RasterEngrave => {
                            ui.label("DPI");
...
fn default_process_values() -> luxifer_core::MaterialProcessDefaults {
    luxifer_core::MaterialProcessDefaults::from_layer(&luxifer_core::Layer::new(0))
}
