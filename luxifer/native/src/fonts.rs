...
pub struct FontFamily {
    ...
    /// Vom Nutzer importiert (Asset-Katalog / LuxiFer-Fonts-Ordner) — steht in
...
pub fn list_font_families() -> Vec<FontFamily> {
    ...
    // (Verzeichnis, gilt als importiert): Katalog + LuxiFer-Fonts-Ordner sind
    // Nutzer-Bestand, der Rest System.
    let dirs = [
        (format!("{home}/.local/share/luxifer/Fonts"), true),
