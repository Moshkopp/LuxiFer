...
use egui::RichText;
use studio_application::{InboxEntry, InboxStatus};
use studio_core::project::ProjectInfo;
...
pub(crate) fn preview_from_state(state: &AppState) -> ProjectPreview {
    ...
    for shape in &state.shapes {
        ...
        if let studio_core::Geo::Image { asset, .. } = &shape.geo {
        ...
        .filter(|asset| {
            matches!(
                ...
                studio_core::AssetKind::Image
                    | studio_core::AssetKind::SvgSource
                    | studio_core::AssetKind::DxfSource
            )
        })
        .filter(|asset| {
                                    ...
                                    .allocate_ui_with_layout(
                                        ...
                                        |ui| {
                                            ...
                                            ui.weak(match asset.kind {
                                                studio_core::AssetKind::Image => "Bild",
                                                studio_core::AssetKind::SvgSource => "SVG",
                                                studio_core::AssetKind::DxfSource => "DXF",
                                                studio_core::AssetKind::Font => "Font",
                                            });
