...
pub struct PreviewGeometry {
    ...
    pub rasters: Vec<studio_core::RasterTexture>,
...
pub fn preview_vertices(
    session: &EditorSession,
    preview: &studio_core::ExecutionTrace,
    material: PreviewMaterial,
    show_travel: bool,
    show_laser_path: bool,
    show_scan_offset: bool,
    bed_origin: studio_core::BedOrigin,
) -> PreviewGeometry {
    ...
    let display_point = |point: studio_core::Pt| {
    ...
    for movement in &preview.moves {
        let color = match movement.kind {
            studio_core::ExecutionKind::Travel => {
...
mod tests {
    ...
    fn preview_spiegelt_maschinenkoordinaten_zurueck_in_den_canvas() {
        ...
        let geometry = preview_vertices(
            ...
            false,
            false,
            studio_core::BedOrigin::BottomRight,
        );
