...
- Die doppelte Bounding-Box-Berechnung im Canvas wurde reduziert: `Canvas.svelte` verwendet jetzt die gemeinsame Frontend-Hilfsfunktion `shapeBBox`.
...
Noch offen bleiben insbesondere die kanonische Auswahlbox direkt aus dem Core, die Text-Metadaten bei Skalierung, der Core-basierte Bézier-Hit-Test, die einheitliche Fehlerbehandlung, die Modulzerlegung und ein vollständig grünes Clippy-Gate.
